...
/**
 * Default {@link PrettyPrinter} implementation that uses 2-space indentation with platform-default linefeeds. Usually this class is not
 * instantiated directly, but instead method {@link JsonGenerator#useDefaultPrettyPrinter} is used, which will use an instance of this class
 * for operation.
 */
...
public class DefaultPrettyPrinter implements PrettyPrinter, Instantiatable<DefaultPrettyPrinter>, java.io.Serializable {
	...
	/**
	 * Interface that defines objects that can produce indentation used to separate object entries and array values. Indentation in this
	 * context just means insertion of white space, independent of whether linefeeds are output.
	 */
	...
	/**
	 * By default, let's use linefeed-adding indenter for separate object entries. We'll further configure indenter to use system-specific
	...
	/**
	 * "Mutant factory" method that will return a pretty printer instance that does use spaces inside object entries; if 'this' instance
	 * already does this, it is returned; if not, a new instance will be constructed and returned.
	 * 
	 * @since 2.3
	 */
	...
	/**
	 * "Mutant factory" method that will return a pretty printer instance that does not use spaces inside object entries; if 'this' instance
	 * already does this, it is returned; if not, a new instance will be constructed and returned.
	 * 
	 * @since 2.3
	 */
	 ...
	 * <p>
	 * Default handling (without pretty-printing) will output a single colon to separate the two. Pretty-printer is to output a colon as well,
	 * but can surround that with other (white-space) decoration.
	 */
	@Override
	 ...
	 * <p>
	 * Default handling (without pretty-printing) will output a single comma to separate the two. Pretty-printer is to output a comma as well,
	 * but can surround that with other (white-space) decoration.
	 */
	@Override
