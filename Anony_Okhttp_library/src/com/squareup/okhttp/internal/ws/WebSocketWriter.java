 ...
 * <p>
 * This class is partially thread safe. Only a single "main" thread should be sending messages via calls to {@link #newMessageSink},
 * {@link #writePing}, or {@link #writeClose}. Other threads may call {@link #writePing}, {@link #writePong}, or {@link #writeClose} which
 * will interleave on the wire with frames from the "main" sending thread.
 */
@SuppressLint("Assert") public final class WebSocketWriter {
	 ...
	 * 
	 * @param code
	 *        Status code as defined by <a href="http://tools.ietf.org/html/rfc6455#section-7.4">Section 7.4 of RFC 6455</a> or {@code 0}.
	 * @param reason
